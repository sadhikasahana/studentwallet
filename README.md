...
## ⚙️Core Workflow (Methodology)

- Students add daily expenses in the app
- System stores and categorizes them in MongoDB
- Dashboard visualizes spending pattern
- When spending crosses threshold → alert pushed
- If overspending continues → automatic email sent to parents
